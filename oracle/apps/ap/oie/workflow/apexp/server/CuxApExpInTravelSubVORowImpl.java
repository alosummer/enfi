...
// ---------------------------------------------------------------------
public class CuxApExpInTravelSubVORowImpl extends OAViewRowImpl {
     ...
     */
    public CuxApExpInTravelSubVORowImpl() {
    }

    /**Gets the attribute value for the calculated attribute SubsidyLineId
     */
    public Number getSubsidyLineId() {
        return (Number)getAttributeInternal(SUBSIDYLINEID);
    }

    /**Sets <code>value</code> as the attribute value for the calculated attribute SubsidyLineId
     */
    ...
    /**Gets the attribute value for the calculated attribute IsSepcialSite
     */
    public String getIsSepcialSite() {
        return (String)getAttributeInternal(ISSEPCIALSITE);
    }

    /**Sets <code>value</code> as the attribute value for the calculated attribute IsSepcialSite
     */
