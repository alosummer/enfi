...
// ---------------------------------------------------------------------
public class CuxApExpOutTravelOtherFeeLineSubVORowImpl extends OAViewRowImpl {
     ...
     */
    public CuxApExpOutTravelOtherFeeLineSubVORowImpl() {
    }

    /**Gets the attribute value for the calculated attribute OtherFeeLineId
     */
    public Number getOtherFeeLineId() {
        return (Number)getAttributeInternal(OTHERFEELINEID);
    }

    /**Sets <code>value</code> as the attribute value for the calculated attribute OtherFeeLineId
     */
    ...
    /**Gets the attribute value for the calculated attribute FeeDate
     */
    public Date getFeeDate() {
        return (Date)getAttributeInternal(FEEDATE);
    }

    /**Sets <code>value</code> as the attribute value for the calculated attribute FeeDate
     */
    public void setFeeDate(Date value) {
        setAttributeInternal(FEEDATE, value);
    }

    /**Gets the attribute value for the calculated attribute FeeAmount
     */
    public Number getFeeAmount() {
        return (Number)getAttributeInternal(FEEAMOUNT);
    }

    /**Sets <code>value</code> as the attribute value for the calculated attribute FeeAmount
     */
