...
// ---------------------------------------------------------------------
public class CuxApExpOtherFeeEOImpl extends OAEntityImpl {
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = 
                    (OAEntityDefImpl)EntityDefImpl.findDefObject("cux.oracle.apps.ap.oie.entry.header.server.CuxApExpOtherFeeEO");
        }
        return mDefinitionObject;
    }

    /**Gets the attribute value for OtherFeeLineId, using the alias name OtherFeeLineId
     */
    public Number getOtherFeeLineId() {
        return (Number)getAttributeInternal(OTHERFEELINEID);
    }

    /**Sets <code>value</code> as the attribute value for OtherFeeLineId
     */
    ...
    /**Gets the attribute value for FeeDate, using the alias name FeeDate
     */
    public Date getFeeDate() {
        return (Date)getAttributeInternal(FEEDATE);
    }

    /**Sets <code>value</code> as the attribute value for FeeDate
     */
    public void setFeeDate(Date value) {
        setAttributeInternal(FEEDATE, value);
    }

    /**Gets the attribute value for FeeAmount, using the alias name FeeAmount
     */
    public Number getFeeAmount() {
        return (Number)getAttributeInternal(FEEAMOUNT);
    }

    /**Sets <code>value</code> as the attribute value for FeeAmount
     */
    public void setFeeAmount(Number value) {
        if ("N".equals(this.getAboardFlag()) && value != null) {
            if (value.compareTo(0) < 0) {
                throw // EO name
                    ...
                    new OAAttrValException(OAException.TYP_ENTITY_OBJECT, 
                                           ...
                                           getPrimaryKey(), "FeeAmount", value, 
                                           "CUX", "CUX_APEXP_OTH_SUB_EXPENSE");
            }
        } else if ("Y".equals(this.getAboardFlag()) && value != null) {
            if (value.compareTo(0) < 0) {
                throw // EO name
                    // EO PK
                    // Attribute Name
    ...
    /**Gets the attribute value for AboardFlag, using the alias name AboardFlag
     */
    public String getAboardFlag() {
        return (String)getAttributeInternal(ABOARDFLAG);
    }

    /**Sets <code>value</code> as the attribute value for AboardFlag
     */
     ...
     */
    public static Key createPrimaryKey(Number otherFeeLineId) {
        return new Key(new Object[] { otherFeeLineId });
    }
}
