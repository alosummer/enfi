...
// ---------------------------------------------------------------------
public class CuxApExpTrafficReimbVORowImpl extends OAViewRowImpl {
     ...
     */
    public CuxApExpTrafficReimbVORowImpl() {
    }

    /**Gets CuxApExpTrafficReimbEO entity object.
     */
    public CuxApExpTrafficReimbEOImpl getCuxApExpTrafficReimbEO() {
        return (CuxApExpTrafficReimbEOImpl)getEntity(0);
    }

    /**Gets the attribute value for TRAFFIC_REIMB_LINE_ID using the alias name TrafficReimbLineId
     */
    public Number getTrafficReimbLineId() {
        return (Number)getAttributeInternal(TRAFFICREIMBLINEID);
    }

    /**Sets <code>value</code> as attribute value for TRAFFIC_REIMB_LINE_ID using the alias name TrafficReimbLineId
     */
    ...
    /**Gets the attribute value for START_SITE using the alias name StartSite
     */
    public String getStartSite() {
        return (String)getAttributeInternal(STARTSITE);
    }

    /**Sets <code>value</code> as attribute value for START_SITE using the alias name StartSite
     */
    public void setStartSite(String value) {
        setAttributeInternal(STARTSITE, value);
    }

    /**Gets the attribute value for END_SITE using the alias name EndSite
     */
    public String getEndSite() {
        return (String)getAttributeInternal(ENDSITE);
    }

    /**Sets <code>value</code> as attribute value for END_SITE using the alias name EndSite
     */
    public void setEndSite(String value) {
        setAttributeInternal(ENDSITE, value);
    }

    /**Gets the attribute value for TRAFFIC_TYPE using the alias name TrafficType
     */
    public String getTrafficType() {
        return (String)getAttributeInternal(TRAFFICTYPE);
    }

    /**Sets <code>value</code> as attribute value for TRAFFIC_TYPE using the alias name TrafficType
     */
    public void setTrafficType(String value) {
        setAttributeInternal(TRAFFICTYPE, value);
    }

    /**Gets the attribute value for TRAFFIC_NUMBER using the alias name TrafficNumber
     */
    public String getTrafficNumber() {
        return (String)getAttributeInternal(TRAFFICNUMBER);
    }

    /**Sets <code>value</code> as attribute value for TRAFFIC_NUMBER using the alias name TrafficNumber
     */
    public void setTrafficNumber(String value) {
        setAttributeInternal(TRAFFICNUMBER, value);
    }

    /**Gets the attribute value for TRAFFIC_FEE using the alias name TrafficFee
     */
    public Number getTrafficFee() {
        return (Number)getAttributeInternal(TRAFFICFEE);
    }

    /**Sets <code>value</code> as attribute value for TRAFFIC_FEE using the alias name TrafficFee
     */
    public void setTrafficFee(Number value) {
        setAttributeInternal(TRAFFICFEE, value);
    }

    /**Gets the attribute value for BUY_TICKET_FEE using the alias name BuyTicketFee
     */
    public Number getBuyTicketFee() {
        return (Number)getAttributeInternal(BUYTICKETFEE);
    }

    /**Sets <code>value</code> as attribute value for BUY_TICKET_FEE using the alias name BuyTicketFee
     */
    public void setBuyTicketFee(Number value) {
        setAttributeInternal(BUYTICKETFEE, value);
    }

    /**Gets the attribute value for LEVEL_SUBSIDY using the alias name LevelSubsidy
     */
    public Number getLevelSubsidy() {
        return (Number)getAttributeInternal(LEVELSUBSIDY);
    }

    /**Sets <code>value</code> as attribute value for LEVEL_SUBSIDY using the alias name LevelSubsidy
     */
    public void setLevelSubsidy(Number value) {
        setAttributeInternal(LEVELSUBSIDY, value);
    }

    /**Gets the attribute value for OVERTIME_SUBSIDY using the alias name OvertimeSubsidy
     */
    public Number getOvertimeSubsidy() {
        return (Number)getAttributeInternal(OVERTIMESUBSIDY);
    }

    /**Sets <code>value</code> as attribute value for OVERTIME_SUBSIDY using the alias name OvertimeSubsidy
     */
    public void setOvertimeSubsidy(Number value) {
        setAttributeInternal(OVERTIMESUBSIDY, value);
    }

    /**Gets the attribute value for PUBLIC_TRAFFIC_FEE_IN_JING using the alias name PublicTrafficFeeInJing
     */
    public Number getPublicTrafficFeeInJing() {
        return (Number)getAttributeInternal(PUBLICTRAFFICFEEINJING);
    }

    /**Sets <code>value</code> as attribute value for PUBLIC_TRAFFIC_FEE_IN_JING using the alias name PublicTrafficFeeInJing
     */
    public void setPublicTrafficFeeInJing(Number value) {
        setAttributeInternal(PUBLICTRAFFICFEEINJING, value);
    }

    /**Gets the attribute value for TAXI_FEE_IN_JING using the alias name TaxiFeeInJing
     */
    public Number getTaxiFeeInJing() {
        return (Number)getAttributeInternal(TAXIFEEINJING);
    }

    /**Sets <code>value</code> as attribute value for TAXI_FEE_IN_JING using the alias name TaxiFeeInJing
     */
    public void setTaxiFeeInJing(Number value) {
        setAttributeInternal(TAXIFEEINJING, value);
    }

    /**Gets the attribute value for TOTAL_TRAFFIC_FEE_OUT_JING using the alias name TotalTrafficFeeOutJing
     */
    public Number getTotalTrafficFeeOutJing() {
        return (Number)getAttributeInternal(TOTALTRAFFICFEEOUTJING);
    }

    /**Sets <code>value</code> as attribute value for TOTAL_TRAFFIC_FEE_OUT_JING using the alias name TotalTrafficFeeOutJing
     */
