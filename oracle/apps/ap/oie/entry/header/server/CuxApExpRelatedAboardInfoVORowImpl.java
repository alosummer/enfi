...
// ---------------------------------------------------------------------
public class CuxApExpRelatedAboardInfoVORowImpl extends OAViewRowImpl {
     ...
     */
    public CuxApExpRelatedAboardInfoVORowImpl() {
    }
    ...
    /**Gets the attribute value for ABOURD_START_DATE using the alias name AbourdStartDate
     */
    public Date getAbourdStartDate() {
        return (Date)getAttributeInternal(ABOURDSTARTDATE);
    }

    /**Sets <code>value</code> as attribute value for ABOURD_START_DATE using the alias name AbourdStartDate
     */
    public void setAbourdStartDate(Date value) {
        setAttributeInternal(ABOURDSTARTDATE, value);

        if (value != null && this.getAbourdEndDate() != null) {
            long diff = 
                this.getAbourdEndDate().getValue().getTime() - value.getValue().getTime();
            int days = (int)(diff / (1000 * 60 * 60 * 24)) + 1;
            this.setTravelDaysNumber(new Number(days));
        } else {
            this.setTravelDaysNumber(new Number(0));
        }

    }

    /**Gets the attribute value for ABOURD_END_DATE using the alias name AbourdEndDate
     */
    public Date getAbourdEndDate() {
        return (Date)getAttributeInternal(ABOURDENDDATE);
    }

    /**Sets <code>value</code> as attribute value for ABOURD_END_DATE using the alias name AbourdEndDate
     */
    public void setAbourdEndDate(Date value) {
        setAttributeInternal(ABOURDENDDATE, value);
        if (value != null && this.getAbourdStartDate() != null) {
            long diff = 
                value.getValue().getTime() - this.getAbourdStartDate().getValue().getTime();
            int days = (int)(diff / (1000 * 60 * 60 * 24)) + 1;
            this.setTravelDaysNumber(new Number(days));
        } else {
            this.setTravelDaysNumber(new Number(0));
