...
// ---------------------------------------------------------------------
public class CuxApExpAccomFeeVOImpl extends OAViewObjectImpl {
    /**This is the default constructor (do not remove)
     */
    public CuxApExpAccomFeeVOImpl() {
    }
    ...
    public Number getMaxLineNumber() {
        if (this.isExecuted()) {
            ...
            if (fetchedRowCount > 0) {
                ...
                CuxApExpAccomFeeVORowImpl reimbRow = null;
                for (int i = fetchedRowCount - 1; i >= 0; i--) {
                    reimbRow = 
                            (CuxApExpAccomFeeVORowImpl)maxLineNumberIter.getRowAtRangeIndex(i);
