...
// ---------------------------------------------------------------------
public class CuxApExpTravelSubsidyEOImpl extends OAEntityImpl {
     ...
     */
    public CuxApExpTravelSubsidyEOImpl() {
    }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = 
                    (OAEntityDefImpl)EntityDefImpl.findDefObject("cux.oracle.apps.ap.oie.entry.header.server.CuxApExpTravelSubsidyEO");
        }
        return mDefinitionObject;
    }

    /**Gets the attribute value for SubsidyLineId, using the alias name SubsidyLineId
     */
    public Number getSubsidyLineId() {
        return (Number)getAttributeInternal(SUBSIDYLINEID);
    }

    /**Sets <code>value</code> as the attribute value for SubsidyLineId
     */
            ...
            if (this.getStartDate().compareTo(value) > 0) {
                throw // EO name
                    ...
                    new OAAttrValException(OAException.TYP_ENTITY_OBJECT, 
                                           ...
                                           "CUX", 
                                           "CUX_APEXP_TRAVEL_SUB_END_DATE");
            }
        }
        setAttributeInternal(ENDDATE, value);
    }

    /**Gets the attribute value for IsSepcialSite, using the alias name IsSepcialSite
     */
    public String getIsSepcialSite() {
        return (String)getAttributeInternal(ISSEPCIALSITE);
    }

    /**Sets <code>value</code> as the attribute value for IsSepcialSite
     */
     ...
     */
    public static Key createPrimaryKey(Number subsidyLineId) {
        return new Key(new Object[] { subsidyLineId });
    }
