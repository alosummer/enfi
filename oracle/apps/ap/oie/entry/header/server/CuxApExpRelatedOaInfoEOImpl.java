...
// ---------------------------------------------------------------------
public class CuxApExpRelatedOaInfoEOImpl extends OAEntityImpl {
    ...
    public static final int ABOURDENDDATE = 25;
     ...
     */
    public CuxApExpRelatedOaInfoEOImpl() {
    }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = 
                    (OAEntityDefImpl)EntityDefImpl.findDefObject("cux.oracle.apps.ap.oie.entry.header.server.CuxApExpRelatedOaInfoEO");
        }
    ...
    /**Gets the attribute value for OaTravelProcessId, using the alias name OaTravelProcessId
     */
    public Number getOaTravelProcessId() {
        return (Number)getAttributeInternal(OATRAVELPROCESSID);
    }

    /**Sets <code>value</code> as the attribute value for OaTravelProcessId
     */
    public void setOaTravelProcessId(Number value) {
        setAttributeInternal(OATRAVELPROCESSID, value);
    }

    /**Gets the attribute value for OaOutseaTravelProcessId, using the alias name OaOutseaTravelProcessId
     */
    public Number getOaOutseaTravelProcessId() {
        return (Number)getAttributeInternal(OAOUTSEATRAVELPROCESSID);
    }

    /**Sets <code>value</code> as the attribute value for OaOutseaTravelProcessId
     */
    ...
    /**Gets the attribute value for AbourdEndDate, using the alias name AbourdEndDate
     */
    public Date getAbourdEndDate() {
        return (Date)getAttributeInternal(ABOURDENDDATE);
    }

    /**Sets <code>value</code> as the attribute value for AbourdEndDate
     */
    public void setAbourdEndDate(Date value) {
        setAttributeInternal(ABOURDENDDATE, value);
    }

    /**Gets the attribute value for AbourdStartDate, using the alias name AbourdStartDate
     */
    public Date getAbourdStartDate() {
        return (Date)getAttributeInternal(ABOURDSTARTDATE);
    }

    /**Sets <code>value</code> as the attribute value for AbourdStartDate
     */
    ...
    public static Key createPrimaryKey(Number relationshipId) {
        return new Key(new Object[] { relationshipId });
    }
}
