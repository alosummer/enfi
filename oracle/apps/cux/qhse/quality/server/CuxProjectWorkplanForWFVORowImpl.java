...
// ---------------------------------------------------------------------
public class CuxProjectWorkplanForWFVORowImpl extends OAViewRowImpl {
    ...
    public static final int SHOWDETAIL = 15;
    public static final int CUXQUALITYMAGDETAILFORWFVO = 16;

    /**This is the default constructor (do not remove)
     */
    public CuxProjectWorkplanForWFVORowImpl() {
    }
    ...
    protected Object getAttrInvokeAccessor(int index, 
        ...
        case CUXQUALITYMAGDETAILFORWFVO:
            return getCuxQualityMagDetailForWFVO();
        default:
    ...
    /**Gets the associated <code>RowIterator</code> using master-detail link CuxQualityMagDetailForWFVO
     */
    public RowIterator getCuxQualityMagDetailForWFVO() {
        return (RowIterator)getAttributeInternal(CUXQUALITYMAGDETAILFORWFVO);
    }
