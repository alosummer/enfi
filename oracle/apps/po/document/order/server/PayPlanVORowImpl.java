...
// ---------------------------------------------------------------------
public class PayPlanVORowImpl extends OAViewRowImpl {
    ...
    public static final int PAYAPPLYDATE = 18;
    public static final int PAIDAMT = 19;
     ...
     */
    public PayPlanVORowImpl() {
    }

    /**Gets CuxPoPayPlanTEO entity object.
     */
    public CuxPoPayPlanTEOImpl getCuxPoPayPlanTEO() {
        return (CuxPoPayPlanTEOImpl)getEntity(0);
    }
    ...
    public void setAttribute5(String value) {
        if ("N".equals(this.getAttribute5()) || null == this.getAttribute5()) {
            if ("Y".equals(value)) {
                this.setAttribute6(new Date().getCurrentDate().toString());
            }
        }
        if ("Y".equals(this.getAttribute5())) {
            if ("N".equals(value) || null == value) {
                this.setAttribute6(null);
            }
        }
    ...
    public static void main(String[] args) {
        System.out.println(new Date().getCurrentDate().toString());
    }
}
