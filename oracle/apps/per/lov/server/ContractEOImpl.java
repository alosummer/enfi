...
public class ContractEOImpl extends OAEntityImpl {
    ...
    public static final int SIGNDATE = 4;
    public static final int PROMISEEPERSONID = 5;
    public static final int PROMISERPERSONID = 6;
    public static final int PROMISEEDEPTID = 7;
    public static final int WEIGHT = 8;
    public static final int TARGETVALUE = 9;
    public static final int MINIMUMVALUE = 10;
    public static final int RATINGMETHOD = 11;
    public static final int SHOWSEQ = 12;
    public static final int KPIID = 13;
    public static final int KPIAREA = 14;
    public static final int KPINAME = 15;
    public static final int KPIDESC = 16;
    public static final int KPICLASS = 17;
    public static final int KPIDATASOURCE = 18;
    public static final int KPIDATADIMENSION = 19;
    public static final int KPISCORINGMETHOD = 20;
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = 
                    (ContractEODefImpl)EntityDefImpl.findDefObject("cux.oracle.apps.per.lov.server.ContractEO");
        }
    ...
    /**Gets the attribute value for PromiseePersonId, using the alias name PromiseePersonId
     */
    public Number getPromiseePersonId() {
        return (Number)getAttributeInternal(PROMISEEPERSONID);
    }

    /**Sets <code>value</code> as the attribute value for PromiseePersonId
     */
    public void setPromiseePersonId(Number value) {
        setAttributeInternal(PROMISEEPERSONID, value);
    }
    ...
    /**Gets the attribute value for PromiseeDeptId, using the alias name PromiseeDeptId
     */
    public Number getPromiseeDeptId() {
        return (Number)getAttributeInternal(PROMISEEDEPTID);
    }

    /**Sets <code>value</code> as the attribute value for PromiseeDeptId
     */
    public void setPromiseeDeptId(Number value) {
        setAttributeInternal(PROMISEEDEPTID, value);
    }
    ...
    protected Object getAttrInvokeAccessor(int index, 
        ...
        case SIGNDATE:
            return getSignDate();
        case PROMISEEPERSONID:
            return getPromiseePersonId();
        case PROMISERPERSONID:
            return getPromiserPersonId();
        case PROMISEEDEPTID:
            return getPromiseeDeptId();
        case WEIGHT:
            return getWeight();
        case TARGETVALUE:
    ...
    protected void setAttrInvokeAccessor(int index, Object value, 
        ...
        case SIGNDATE:
            ...
            return;
        case PROMISEEPERSONID:
            setPromiseePersonId((Number)value);
            return;
        case PROMISERPERSONID:
            setPromiserPersonId((Number)value);
            return;
        case PROMISEEDEPTID:
            setPromiseeDeptId((Number)value);
            return;
        case WEIGHT:
