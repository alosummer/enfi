...
/**
 * 绩效管理_经理自助，目标设定阶段，可修改界面（未批准之前）
 * created by yang.gang,2016-4-27
 */
public class ManagerGoalUpdateCO extends OAControllerImpl {
    ...
    public void processFormRequest(OAPageContext pageContext, 
        ...
        if ((kpi_tableBean != null) && 
            (kpi_tableBean.getName().equals(pageContext.getParameter("source"))) && 
            ("addRows".equals(event)))
            this.AddKPINewRow(pageContext, webBean, iAprID);
        else if ((taks_tableBean != null) && 
                 (taks_tableBean.getName().equals(pageContext.getParameter("source"))) && 
                 ("addRows".equals(event)))
        ...
        else if (pageContext.getParameter("Apply") != null) //提交，批准绩效合同
    ...
    private void initWeb(OAPageContext pageContext, OAWebBean webBean) {
        ...
        if ("NO_DATA".equals(PhaseId) || "NO_DATA".equals(IsPromisee)) {
            ...
            String strUrl = 
                "OA.jsp?page=/cux/oracle/apps/per/aprprocess/webui/ManagerGOALReadOnlyPG&appraisalid=".concat(appraisalId);
    ...
    private void initWebButton(OAPageContext pageContext, OAWebBean webBean, 
        ...
        if (submitButton != null)
            returnButton.setOnClick("javascript:return CtlBtnStatus(this);");
    }
    ...
    private void SaveData(OAPageContext pageContext, OAWebBean webBean, 
        ...
        if ("s".equals(strRtn)) {
            ...
            this.ShowMessage(pageContext, "数据验证失败：".concat(strRtn));
    }
    ...
    private void SubmitApr(OAPageContext pageContext, OAWebBean webBean, 
        ...
        if ("Y".equals(strRtn)) { //提交成功，返回
            ...
            pageContext.putSessionValue("backFromContract", 
                                        "N"); //标识位，显示当年待办清单
            TransactionUnitHelper.endTransactionUnit(pageContext, 
                                                     "updateContractKPITxn");
        ...
        this.ShowMessage(pageContext, "绩效合同审批提交失败，请联系系统管理员！");
    ...
    private void RejectApr(OAPageContext pageContext, OAWebBean webBean, 
        ...
        if ("Y".equals(strRtn)) { //提交成功，返回
            ...
            pageContext.putSessionValue("backFromContract", "N");
            TransactionUnitHelper.endTransactionUnit(pageContext, 
                                                     "updateContractKPITxn");
