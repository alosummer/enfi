...
// ---------------------------------------------------------------------
// ---    绩效管理_经理自助/员工自助，绩效合同界面，显示选定绩效合同的信息（评分阶段完成后）
// ---     created by yang.gang,2016-11-11
// ---------------------------------------------------------------------
public class AprFinishDetailVOImpl extends OAViewObjectImpl {
    /**This is the default constructor (do not remove)
     */
    public AprFinishDetailVOImpl() {
    }
