...
import cux.oracle.apps.per.review.server.TmplOrgVOImpl;
 ...
 * Controller for ...
 */
public class TmplOrgCO extends OAControllerImpl {
    ...
    public void processRequest(OAPageContext pageContext, OAWebBean webBean) {
        ...
        TmplOrgVOImpl vo = (TmplOrgVOImpl)am.findViewObject("TmplOrgVO1");
        if (pageContext.getParameter("refresh") != null) {
            vo.executeQuery();
        }

        OATableBean tableBean = 
            (OATableBean)webBean.findChildRecursive("TmplOrgVO1");
        ...
        if (tmplId != null) {
            ...
            am.invokeMethod("initTemplateOrg", params);
    ...
    public void processFormRequest(OAPageContext pageContext, 
        ...
        if (tableBean != null && 
            ...
            OAViewObject vo = (OAViewObject)am.findViewObject("TmplOrgVO1");
        ...
        if ("delete".equals(pageContext.getParameter("event"))) {
            String tmplId = pageContext.getParameter("tmplId");
            String organizationId = pageContext.getParameter("organizationId");
            ...
            formParams.put("organizationId", organizationId);
            ...
            String tmplId = pageContext.getParameter("tmplId");
            String organizationId = pageContext.getParameter("organizationId");
            Serializable[] params = { tmplId, organizationId };
            result = (String)am.invokeMethod("delTemplateOrg", params);
            OAException confirmMessage = 
                new OAException("CUX", "CUX_DEL_TMPL_ORG_CONF", null, 
                                OAException.CONFIRMATION, null);
            pageContext.putDialogMessage(confirmMessage);
            pageContext.forwardImmediately("OA.jsp?page=/cux/oracle/apps/per/review/webui/TmplOrgPG&refresh=Y", 
                                           null, 
        ...
        if (pageContext.getParameter("Apply") != null) {
            ...
            OAException confirmMessage = 
                new OAException("CUX", "CUX_TMPL_ORG_SAVED", null, 
                                OAException.CONFIRMATION, null);
            pageContext.putDialogMessage(confirmMessage);
