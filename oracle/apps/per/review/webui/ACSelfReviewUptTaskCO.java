...
/**绩效管理_员工自助
 * 更新绩效合同页面 - 工作任务 (不能进行新增行)
 * add by yang.gang, 2015-12-17
 */
public class ACSelfReviewUptTaskCO extends OAControllerImpl {
    ...
    public void processRequest(OAPageContext pageContext, OAWebBean webBean) {
        ...
        if ("".equals(appraisalId) || !"TASK".equals(kpiClass) || 
            !"selfservice".equals(role) || !"REVIEW".equals(phaseId)) {
    ...
    private void SaveData(OAPageContext pageContext, OAWebBean webBean) {
        AppraisalAMImpl amImpl = 
            (AppraisalAMImpl)pageContext.getApplicationModule(webBean);
        amImpl.validateManualKpiSelfScore();
