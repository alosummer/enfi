...
// ---------------------------------------------------------------------
public class TemplateContentEOImpl extends OAEntityImpl {
    ...
    private static TemplateContentEODefImpl mDefinitionObject;

    /**This is the default constructor (do not remove)
     */
    public TemplateContentEOImpl() {
    }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = 
                    (TemplateContentEODefImpl)EntityDefImpl.findDefObject("cux.oracle.apps.per.review.server.TemplateContentEO");
        }
     ...
     */
    public static Key createPrimaryKey(Number contentId) {
        return new Key(new Object[] { contentId });
    }
}
