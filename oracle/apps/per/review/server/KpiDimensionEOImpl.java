...
// ---------------------------------------------------------------------
public class KpiDimensionEOImpl extends OAEntityImpl {
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = 
                    (OAEntityDefImpl)EntityDefImpl.findDefObject("cux.oracle.apps.per.review.server.KpiDimensionEO");
        }
    ...
    /**Gets the attribute value for ValuesetName, using the alias name ValuesetName
     */
    public String getValuesetName() {
        return (String)getAttributeInternal(VALUESETNAME);
    }

    /**Sets <code>value</code> as the attribute value for ValuesetName
     */
     ...
     */
    public static Key createPrimaryKey(Number dimensionId) {
