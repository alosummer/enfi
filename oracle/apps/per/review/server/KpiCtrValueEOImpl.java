...
// ---------------------------------------------------------------------
public class KpiCtrValueEOImpl extends OAEntityImpl {
    ...
    public static final int DIMENSIONVALUE = 4;
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = 
                    (OAEntityDefImpl)EntityDefImpl.findDefObject("cux.oracle.apps.per.review.server.KpiCtrValueEO");
        }
    ...
    /**Gets the attribute value for DimensionValue, using the alias name DimensionValue
     */
    public String getDimensionValue() {
        return (String)getAttributeInternal(DIMENSIONVALUE);
    }

    /**Sets <code>value</code> as the attribute value for DimensionValue
     */
     ...
     */
    public static Key createPrimaryKey(Number valueId) {
