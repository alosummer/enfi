...
// ---------------------------------------------------------------------
public class KpiCtrValueVORowImpl extends OAViewRowImpl {
    public static final int ROWNUM = 0;
    public static final int VALUEID = 1;
    public static final int CONSTRAINTID = 2;
    public static final int KPIID = 3;
    public static final int DIMENSIONID = 4;
    public static final int DIMENSIONVALUE = 5;
    ...
    public static final int DIMENSIONNAME = 16;
    public static final int VALUESETNAME = 17;

    /**This is the default constructor (do not remove)
     */
    public KpiCtrValueVORowImpl() {
    }

    /**Gets KpiCtrValueEO entity object.
     */
    public KpiCtrValueEOImpl getKpiCtrValueEO() {
        return (KpiCtrValueEOImpl)getEntity(0);
    }
    ...
    /**Gets the attribute value for DIMENSION_VALUE using the alias name DimensionValue
     */
    public String getDimensionValue() {
        return (String)getAttributeInternal(DIMENSIONVALUE);
    }

    /**Sets <code>value</code> as attribute value for DIMENSION_VALUE using the alias name DimensionValue
     */
    public void setDimensionValue(String value) {
        setAttributeInternal(DIMENSIONVALUE, value);
    }
