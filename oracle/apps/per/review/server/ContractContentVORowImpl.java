...
// ---------------------------------------------------------------------
public class ContractContentVORowImpl extends OAViewRowImpl {
    ...
    public static final int RATINGMETHOD = 6;
    public static final int SHOWSEQ = 7;
    public static final int KPIID = 8;
    public static final int KPIAREA = 9;
    public static final int KPIAREAMEANING = 10;
    public static final int KPINAME = 11;
    public static final int KPIDESC = 12;
    public static final int KPICLASS = 13;
    public static final int KPIDATASOURCE = 14;
    public static final int KPIDATASOURCEMEANING = 15;
    public static final int KPIDATADIMENSION = 16;
    public static final int KPISCORINGMETHOD = 17;
    public static final int KPISCORINGMETHODMEANING = 18;
    ...
    public static final int ACTUALVALUE = 29;
    public static final int SCOREVALUE = 30;
    public static final int SELFEVALVALUE = 31;
    public static final int ACTUALVALUESHOW = 32;
    public static final int SCOREVALUESHOW = 33;
    public static final int PARENTCONTRACTID = 34;
    public static final int UPDATEIMAGE = 35;
    public static final int DELETEIMAGE = 36;
    public static final int ACTUALVALUELINK = 37;
    public static final int KPIDATASOURCEDISPLAY = 38;
    public static final int KPIDATADETAILS = 39;
    public static final int CONTRACTCLASSVO = 40;

    /**This is the default constructor (do not remove)
     */
    public ContractContentVORowImpl() {
    }
    ...
    /**Gets the attribute value for the calculated attribute KpiAreaMeaning
     */
    public String getKpiAreaMeaning() {
        return (String)getAttributeInternal(KPIAREAMEANING);
    }

    /**Sets <code>value</code> as the attribute value for the calculated attribute KpiAreaMeaning
     */
    public void setKpiAreaMeaning(String value) {
        setAttributeInternal(KPIAREAMEANING, value);
    }
    ...
    /**Gets the attribute value for the calculated attribute KpiDataSourceMeaning
     */
    public String getKpiDataSourceMeaning() {
        return (String)getAttributeInternal(KPIDATASOURCEMEANING);
    }

    /**Sets <code>value</code> as the attribute value for the calculated attribute KpiDataSourceMeaning
     */
    public void setKpiDataSourceMeaning(String value) {
        setAttributeInternal(KPIDATASOURCEMEANING, value);
    }
    ...
    /**Gets the attribute value for the calculated attribute KpiScoringMethodMeaning
     */
    public String getKpiScoringMethodMeaning() {
        return (String)getAttributeInternal(KPISCORINGMETHODMEANING);
    }

    /**Sets <code>value</code> as the attribute value for the calculated attribute KpiScoringMethodMeaning
     */
    public void setKpiScoringMethodMeaning(String value) {
        setAttributeInternal(KPISCORINGMETHODMEANING, value);
    }
    ...
    protected Object getAttrInvokeAccessor(int index, 
        ...
        case KPIDATASOURCEMEANING:
            return getKpiDataSourceMeaning();
        case KPIDATADIMENSION:
            return getKpiDataDimension();
        case KPISCORINGMETHOD:
            return getKpiScoringMethod();
        case KPISCORINGMETHODMEANING:
            return getKpiScoringMethodMeaning();
        case ATTRIBUTE1:
        ...
        case KPIDATADETAILS:
            return getKpiDataDetails();
        case CONTRACTCLASSVO:
            return getContractClassVO();
        default:
    ...
    protected void setAttrInvokeAccessor(int index, Object value, 
        ...
        case KPIAREA:
            ...
            return;
        case KPIAREAMEANING:
            setKpiAreaMeaning((String)value);
            return;
        case KPINAME:
        ...
        case KPIDATASOURCE:
            ...
            return;
        case KPIDATASOURCEMEANING:
            setKpiDataSourceMeaning((String)value);
            return;
        case KPIDATADIMENSION:
        ...
        case KPISCORINGMETHOD:
            ...
            return;
        case KPISCORINGMETHODMEANING:
            setKpiScoringMethodMeaning((String)value);
            return;
        case ATTRIBUTE1:
        ...
        case KPIDATASOURCEDISPLAY:
            ...
            return;
        case KPIDATADETAILS:
            setKpiDataDetails((String)value);
            return;
        default:
    ...
    /**Gets the associated <code>Row</code> using master-detail link ContractClassVO
     */
    public Row getContractClassVO() {
        return (Row)getAttributeInternal(CONTRACTCLASSVO);
    }
    ...
    /**Gets the attribute value for the calculated attribute KpiDataDetails
     */
    public String getKpiDataDetails() {
        return (String)getAttributeInternal(KPIDATADETAILS);
    }

    /**Sets <code>value</code> as the attribute value for the calculated attribute KpiDataDetails
     */
    public void setKpiDataDetails(String value) {
        setAttributeInternal(KPIDATADETAILS, value);
    }
}
