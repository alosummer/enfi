...
// ---------------------------------------------------------------------
public class PerReviewGrpVORowImpl extends OAViewRowImpl {
    ...
    public static final int PERGRPRANGEVO = 20;

    /**This is the default constructor (do not remove)
     */
    public PerReviewGrpVORowImpl() {
    }

    /**Gets PerReviewGroupEO entity object.
     */
    public PerReviewGroupEOImpl getPerReviewGroupEO() {
        return (PerReviewGroupEOImpl)getEntity(0);
    }
    ...
    /**Gets the attribute value for FLOW_TYPE using the alias name FlowType
     */
    public String getFlowType() {
        return (String)getAttributeInternal(FLOWTYPE);
    }

    /**Sets <code>value</code> as attribute value for FLOW_TYPE using the alias name FlowType
     */
    public void setFlowType(String value) {
        setAttributeInternal(FLOWTYPE, value);
    }

    /**Gets the attribute value for EPM_LEVELMODE using the alias name EpmLevelmode
     */
    public String getEpmLevelmode() {
        return (String)getAttributeInternal(EPMLEVELMODE);
    }

    /**Sets <code>value</code> as attribute value for EPM_LEVELMODE using the alias name EpmLevelmode
     */
    ...
    /**Gets the associated <code>RowIterator</code> using master-detail link PerGrpRangeVO
     */
    public RowIterator getPerGrpRangeVO() {
        return (RowIterator)getAttributeInternal(PERGRPRANGEVO);
    }
}
