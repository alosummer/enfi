...
// ---------------------------------------------------------------------
public class PerGrpRangeVORowImpl extends OAViewRowImpl {
    ...
    public static final int PERREVIEWGRPVO = 18;

    /**This is the default constructor (do not remove)
     */
    public PerGrpRangeVORowImpl() {
    }

    /**Gets PerGroupRangeEO entity object.
     */
    public PerGroupRangeEOImpl getPerGroupRangeEO() {
        return (PerGroupRangeEOImpl)getEntity(0);
    }
    ...
    /**Gets the associated <code>Row</code> using master-detail link PerReviewGrpVO
     */
    public Row getPerReviewGrpVO() {
        return (Row)getAttributeInternal(PERREVIEWGRPVO);
    }
}
