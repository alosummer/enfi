...
// ---------------------------------------------------------------------
public class CuxBonusOfficeDistributionVORowImpl extends OAViewRowImpl {
    ...
    public static final int TYPENAME = 28;

    /**This is the default constructor (do not remove)
     */
    public CuxBonusOfficeDistributionVORowImpl() {
    }

    /**Gets CuxBonusOfficeDistributionEO entity object.
     */
    public CuxBonusOfficeDistributionEOImpl getCuxBonusOfficeDistributionEO() {
        return (CuxBonusOfficeDistributionEOImpl)getEntity(0);
    }

    /**Gets the attribute value for OFFICE_DISTRIBUTION_ID using the alias name OfficeDistributionId
     */
    public Number getOfficeDistributionId() {
        return (Number)getAttributeInternal(OFFICEDISTRIBUTIONID);
    }

    /**Sets <code>value</code> as attribute value for OFFICE_DISTRIBUTION_ID using the alias name OfficeDistributionId
     */
    public void setOfficeDistributionId(Number value) {
        setAttributeInternal(OFFICEDISTRIBUTIONID, value);
    }

    /**Gets the attribute value for OFFICE_ID using the alias name OfficeId
     */
    public Number getOfficeId() {
        return (Number)getAttributeInternal(OFFICEID);
    }

    /**Sets <code>value</code> as attribute value for OFFICE_ID using the alias name OfficeId
     */
    public void setOfficeId(Number value) {
        setAttributeInternal(OFFICEID, value);
    }

    /**Gets the attribute value for OFFICE_NAME using the alias name OfficeName
     */
    public String getOfficeName() {
        return (String)getAttributeInternal(OFFICENAME);
    }

    /**Sets <code>value</code> as attribute value for OFFICE_NAME using the alias name OfficeName
     */
    ...
    /**Gets the attribute value for DISTRIBUTION_PERIOD using the alias name DistributionPeriod
     */
    public Number getDistributionPeriod() {
        return (Number)getAttributeInternal(DISTRIBUTIONPERIOD);
    }

    /**Sets <code>value</code> as attribute value for DISTRIBUTION_PERIOD using the alias name DistributionPeriod
     */
