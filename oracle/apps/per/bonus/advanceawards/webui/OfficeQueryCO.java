...
import cux.oracle.apps.per.bonus.advanceawards.server.AdvAwardsSummaryOfficeVOImpl;
 ...
 * 部门奖金发放，查询页面
 */
public class OfficeQueryCO extends OAControllerImpl {
    ...
    public void processFormRequest(OAPageContext pageContext, 
        ...
        if ("search".equals(event)) {
            ...
            pageContext.setForwardURL("OA.jsp?page=/cux/oracle/apps/per/bonus/advanceawards/webui/AdvanceAwardsOfficePG", 
                                      null, 
    ...
    public void pageSearchData(OAPageContext pageContext, OAWebBean webBean, 
        ...
        //        OAMessageTextInputBean balanceAmountBean = (OAMessageTextInputBean)webBean.findIndexedChildRecursive("BalanceAmount");
        //        balanceAmountBean.setValue(pageContext, totalBalance);
        //        OAMessageTextInputBean monthAmountBean = (OAMessageTextInputBean)webBean.findIndexedChildRecursive("MonthAmount");
        //        monthAmountBean.setValue(pageContext, monthBalance);
        //        OAMessageTextInputBean AvailAmountBean = (OAMessageTextInputBean)webBean.findIndexedChildRecursive("AvailAmount");
        //        AvailAmountBean.setValue(pageContext, totalBalance + monthBalance);
        //        OAMessageTextInputBean DeptPerAmountBean = (OAMessageTextInputBean)webBean.findIndexedChildRecursive("DeptPersonAmount");
        //        DeptPerAmountBean.setValue(pageContext, deptPerNum);
        //        OAMessageTextInputBean DistPerAmountBean = (OAMessageTextInputBean)webBean.findIndexedChildRecursive("DistPersonAmount");
        //        DistPerAmountBean.setValue(pageContext, otherPerNum);
        //        OAMessageTextInputBean totalDistBean = (OAMessageTextInputBean)webBean.findIndexedChildRecursive("DistAmount");
        //        totalDistBean.setValue(pageContext, totalDist);        

        AdvAwardsSummaryOfficeVOImpl vo1 = 
            (AdvAwardsSummaryOfficeVOImpl)am.findViewObject("AdvAwardsSummaryOfficeVO1");
