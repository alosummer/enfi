 ...
 * 项目状态: 
   ...
   SUBMITTED      已提交  不显示
 */
public class PrjMemberCO extends OAControllerImpl {
    ...
    public void processFormRequest(OAPageContext pageContext, 
        ...
        if (pageContext.getParameter("ReturnButton") != null)
            ...
            createDisPersonRow(pageContext, webBean);
    ...
    private void InitObjAttr(OAWebBean webBean) {
        ...
        SetTableColumnReadOnly("Text", "CNote", "ReadOnlyFlag", 
                               "PrjDistributionVO1", webBean);
        SetTableColumnReadOnly("Lov", "CEmpNo", "ReadOnlyFlag", 
                               "PrjDistributionVO1", webBean);
        SetTableColumnReadOnly("Lov", "CEmpName", "ReadOnlyFlag", 
                               "PrjDistributionVO1", webBean);
        SetTableColumnReadOnly("Lov", "COrgName", "ReadOnlyFlag", 
                               "PrjDistributionVO1", webBean);
    }
   ...
   * */
    ...
    private void RefreshDistData(OAPageContext pageContext, OAWebBean webBean, 
        ...
        if (outerTable != null)
            outerTable.clearCache(pageContext);
        if (innerTable != null)
