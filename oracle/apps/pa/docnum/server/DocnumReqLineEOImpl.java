...
// ---------------------------------------------------------------------
public class DocnumReqLineEOImpl extends OAEntityImpl {
    public static final int REQLINEID = 0;
    public static final int DOCNUMREQID = 1;
    public static final int CUXDLVID = 2;
    public static final int DOCNUM = 3;
    public static final int SYNCFLAG = 4;
    ...
    public static final int LINEDESC = 19;
    private static OAEntityDefImpl mDefinitionObject;

    /**This is the default constructor (do not remove)
     */
    public DocnumReqLineEOImpl() {
    }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = 
                    (OAEntityDefImpl)EntityDefImpl.findDefObject("cux.oracle.apps.pa.docnum.server.DocnumReqLineEO");
        }
    ...
    /**Gets the attribute value for SyncFlag, using the alias name SyncFlag
     */
    public String getSyncFlag() {
        return (String)getAttributeInternal(SYNCFLAG);
    }

    /**Sets <code>value</code> as the attribute value for SyncFlag
     */
    ...
    /**Gets the attribute value for LineDesc, using the alias name LineDesc
     */
    public String getLineDesc() {
        return (String)getAttributeInternal(LINEDESC);
    }

    /**Sets <code>value</code> as the attribute value for LineDesc
     */
     ...
     */
    public static Key createPrimaryKey(Number reqLineId) {
