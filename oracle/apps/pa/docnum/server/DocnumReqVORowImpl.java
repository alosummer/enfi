...
// ---------------------------------------------------------------------
public class DocnumReqVORowImpl extends OAViewRowImpl {
     ...
     */
    public DocnumReqVORowImpl() {
    }

    /**Gets DocnumReqEO entity object.
     */
    public DocnumReqEOImpl getDocnumReqEO() {
        return (DocnumReqEOImpl)getEntity(0);
    }

    /**Gets the attribute value for DOCNUM_REQ_ID using the alias name DocnumReqId
     */
    public Number getDocnumReqId() {
        return (Number)getAttributeInternal(DOCNUMREQID);
    }

    /**Sets <code>value</code> as attribute value for DOCNUM_REQ_ID using the alias name DocnumReqId
     */
    ...
    /**Gets the attribute value for REQ_DESC using the alias name ReqDesc
     */
    public String getReqDesc() {
        return (String)getAttributeInternal(REQDESC);
    }

    /**Sets <code>value</code> as attribute value for REQ_DESC using the alias name ReqDesc
     */
