...
// ---------------------------------------------------------------------
public class DsSummaryEOImpl extends OAEntityImpl {
    public static final int PROJECTID = 0;
    public static final int TASKID = 1;
    public static final int UPDATECOUNT = 2;
    ...
    public static final int FIRSTRELEASEDATE = 18;
    private static DsSummaryEODefImpl mDefinitionObject;

    /**This is the default constructor (do not remove)
     */
    public DsSummaryEOImpl() {
    }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = 
                    (DsSummaryEODefImpl)EntityDefImpl.findDefObject("cux.oracle.apps.pa.ds.server.DsSummaryEO");
        }
    ...
    /**Gets the attribute value for UpdateCount, using the alias name UpdateCount
     */
    public Number getUpdateCount() {
        return (Number)getAttributeInternal(UPDATECOUNT);
    }

    /**Sets <code>value</code> as the attribute value for UpdateCount
     */
    ...
    /**Gets the attribute value for FirstReleaseDate, using the alias name FirstReleaseDate
     */
    public Date getFirstReleaseDate() {
        return (Date)getAttributeInternal(FIRSTRELEASEDATE);
    }

    /**Sets <code>value</code> as the attribute value for FirstReleaseDate
     */
     ...
     */
    public static Key createPrimaryKey(Number projectId, Number taskId) {
        return new Key(new Object[] { projectId, taskId });
    }
}
