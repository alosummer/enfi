...
// ---------------------------------------------------------------------
public class DlvScheduleSpecEOImpl extends OAEntityImpl {
    public static final int SCHEDULESPECID = 0;
    public static final int PROJECTID = 1;
    public static final int TASKID = 2;
    public static final int RELEASESPECIALTY = 3;
    public static final int SPECIALTYMANAGER = 4;
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = 
                    (OAEntityDefImpl)EntityDefImpl.findDefObject("cux.oracle.apps.pa.ds.server.DlvScheduleSpecEO");
        }
    ...
    /**Gets the attribute value for SpecialtyManager, using the alias name SpecialtyManager
     */
    public Number getSpecialtyManager() {
        return (Number)getAttributeInternal(SPECIALTYMANAGER);
    }

    /**Sets <code>value</code> as the attribute value for SpecialtyManager
     */
    ...
    /**Gets the attribute value for ScheduleSpecId, using the alias name ScheduleSpecId
     */
    public Number getScheduleSpecId() {
        return (Number)getAttributeInternal(SCHEDULESPECID);
    }

    /**Sets <code>value</code> as the attribute value for ScheduleSpecId
     */
     ...
     */
    public static Key createPrimaryKey(Number scheduleSpecId) {
        return new Key(new Object[] { scheduleSpecId });
    }
}
