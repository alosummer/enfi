...
public class MhAssignLinesEOImpl extends OAEntityImpl {
    ...
    public static final int ASSIGNID = 18;
    public static final int PROJECTROLE = 19;
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = 
                    (OAEntityDefImpl)EntityDefImpl.findDefObject("cux.oracle.apps.pa.mh.server.MhAssignLinesEO");
        }
    ...
    /**Gets the attribute value for AssignLineId, using the alias name AssignLineId
     */
    public Number getAssignLineId() {
        return (Number)getAttributeInternal(ASSIGNLINEID);
    }

    /**Sets <code>value</code> as the attribute value for AssignLineId
     */
    ...
    /**Gets the attribute value for ManHours, using the alias name ManHours
     */
    public Number getManHours() {
        return (Number)getAttributeInternal(MANHOURS);
    }

    /**Sets <code>value</code> as the attribute value for ManHours
     */
    public void setManHours(Number value) {
        if (value != null && value.intValue() < 0) {
            throw new OARowValException(getEntityDef().getFullName(), 
                                        getPrimaryKey(), "CUX", 
                                        "分配的价值工时不能为负数!", null);
        }
     ...
     */
    public static Key createPrimaryKey(Number assignLineId) {
        return new Key(new Object[] { assignLineId });
    }
}
