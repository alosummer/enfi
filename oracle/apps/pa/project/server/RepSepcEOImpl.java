...
// ---------------------------------------------------------------------
public class RepSepcEOImpl extends OAEntityImpl {
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = 
                    (OAEntityDefImpl)EntityDefImpl.findDefObject("cux.oracle.apps.pa.project.server.RepSepcEO");
        }
    ...
    /**Gets the attribute value for ResourceTypeId, using the alias name ResourceTypeId
     */
    public Number getResourceTypeId() {
        return (Number)getAttributeInternal(RESOURCETYPEID);
    }

    /**Sets <code>value</code> as the attribute value for ResourceTypeId
     */
    public void setResourceTypeId(Number value) {
        setAttributeInternal(RESOURCETYPEID, value);
    }

    /**Gets the attribute value for ResourceSourceId, using the alias name ResourceSourceId
     */
    public Number getResourceSourceId() {
        return (Number)getAttributeInternal(RESOURCESOURCEID);
    }

    /**Sets <code>value</code> as the attribute value for ResourceSourceId
     */
    public void setResourceSourceId(Number value) {
        setAttributeInternal(RESOURCESOURCEID, value);
    }

    /**Gets the attribute value for ProjectRoleId, using the alias name ProjectRoleId
     */
    public Number getProjectRoleId() {
        return (Number)getAttributeInternal(PROJECTROLEID);
    }

    /**Sets <code>value</code> as the attribute value for ProjectRoleId
     */
     ...
     */
    public static Key createPrimaryKey(String atrribute1) {
        return new Key(new Object[] { atrribute1 });
    }
}
