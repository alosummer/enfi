 ...
 * Controller for ...
 */
public class PmpContactCO extends PmpBaseCO {
    ...
    public void processRequest(OAPageContext pageContext, OAWebBean webBean) {
        ...
        am.invokeMethod("initPmpContract", paras);
    ...
    public void processFormRequest(OAPageContext pageContext, 
        ...
        if ("AddFirst".equals(event)) {
            Serializable paras[] = { projectId, versionNum };
            am.invokeMethod("addFirstContactParty", paras);
        }
        if ("AddSecond".equals(event)) {
            Serializable paras[] = { projectId, versionNum };
            am.invokeMethod("addSecondContactParty", paras);
        }
