...
// ---------------------------------------------------------------------
public class PmpRiskEOImpl extends OAEntityImpl {
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = 
                    (OAEntityDefImpl)EntityDefImpl.findDefObject("cux.oracle.apps.pa.pmp.server.PmpRiskEO");
        }
    ...
    /**Gets the attribute value for RiskFactor, using the alias name RiskFactor
     */
    public String getRiskFactor() {
        return (String)getAttributeInternal(RISKFACTOR);
    }

    /**Sets <code>value</code> as the attribute value for RiskFactor
     */
    public void setRiskFactor(String value) {
        setAttributeInternal(RISKFACTOR, value);
    }

    /**Gets the attribute value for RiskEvent, using the alias name RiskEvent
     */
    public String getRiskEvent() {
        return (String)getAttributeInternal(RISKEVENT);
    }

    /**Sets <code>value</code> as the attribute value for RiskEvent
     */
    public void setRiskEvent(String value) {
        setAttributeInternal(RISKEVENT, value);
    }

    /**Gets the attribute value for RiskDesc, using the alias name RiskDesc
     */
    public String getRiskDesc() {
        return (String)getAttributeInternal(RISKDESC);
    }

    /**Sets <code>value</code> as the attribute value for RiskDesc
     */
    public void setRiskDesc(String value) {
        setAttributeInternal(RISKDESC, value);
    }

    /**Gets the attribute value for RiskCounterMeasure, using the alias name RiskCounterMeasure
     */
    public String getRiskCounterMeasure() {
        return (String)getAttributeInternal(RISKCOUNTERMEASURE);
    }

    /**Sets <code>value</code> as the attribute value for RiskCounterMeasure
     */
