...
// ---------------------------------------------------------------------
public class PmpRiskVORowImpl extends OAViewRowImpl {
    public static final int PROJECTID = 0;
    public static final int VERSIONNUM = 1;
    public static final int SEQNUM = 2;
    public static final int RISKFACTOR = 3;
    public static final int RISKEVENT = 4;
    public static final int RISKDESC = 5;
    public static final int RISKCOUNTERMEASURE = 6;
     ...
     */
    public PmpRiskVORowImpl() {
    }

    /**Gets PmpRiskEO entity object.
     */
    public PmpRiskEOImpl getPmpRiskEO() {
        return (PmpRiskEOImpl)getEntity(0);
    }
    ...
    /**Gets the attribute value for SEQ_NUM using the alias name SeqNum
     */
    public Number getSeqNum() {
        return (Number)getAttributeInternal(SEQNUM);
    }

    /**Sets <code>value</code> as attribute value for SEQ_NUM using the alias name SeqNum
     */
    public void setSeqNum(Number value) {
        setAttributeInternal(SEQNUM, value);
    }

    /**Gets the attribute value for RISK_FACTOR using the alias name RiskFactor
     */
    public String getRiskFactor() {
        return (String)getAttributeInternal(RISKFACTOR);
    }

    /**Sets <code>value</code> as attribute value for RISK_FACTOR using the alias name RiskFactor
     */
    public void setRiskFactor(String value) {
        setAttributeInternal(RISKFACTOR, value);
    }

    /**Gets the attribute value for RISK_EVENT using the alias name RiskEvent
     */
    public String getRiskEvent() {
        return (String)getAttributeInternal(RISKEVENT);
    }

    /**Sets <code>value</code> as attribute value for RISK_EVENT using the alias name RiskEvent
     */
    public void setRiskEvent(String value) {
        setAttributeInternal(RISKEVENT, value);
    }

    /**Gets the attribute value for RISK_DESC using the alias name RiskDesc
     */
    public String getRiskDesc() {
        return (String)getAttributeInternal(RISKDESC);
    }

    /**Sets <code>value</code> as attribute value for RISK_DESC using the alias name RiskDesc
     */
    public void setRiskDesc(String value) {
        setAttributeInternal(RISKDESC, value);
    }

    /**Gets the attribute value for RISK_COUNTER_MEASURE using the alias name RiskCounterMeasure
     */
    public String getRiskCounterMeasure() {
        return (String)getAttributeInternal(RISKCOUNTERMEASURE);
    }

    /**Sets <code>value</code> as attribute value for RISK_COUNTER_MEASURE using the alias name RiskCounterMeasure
     */
    public void setRiskCounterMeasure(String value) {
        setAttributeInternal(RISKCOUNTERMEASURE, value);
    }
    ...
    protected Object getAttrInvokeAccessor(int index, 
        ...
        case RISKDESC:
            return getRiskDesc();
        case RISKCOUNTERMEASURE:
            return getRiskCounterMeasure();
        case MEMO:
            return getMemo();
        case ATTRIBUTE1:
    ...
    protected void setAttrInvokeAccessor(int index, Object value, 
        ...
        case SEQNUM:
            ...
            return;
        case RISKFACTOR:
            setRiskFactor((String)value);
            return;
        case RISKEVENT:
            setRiskEvent((String)value);
            return;
        case RISKDESC:
            setRiskDesc((String)value);
            return;
        case RISKCOUNTERMEASURE:
            setRiskCounterMeasure((String)value);
            return;
        case MEMO:
