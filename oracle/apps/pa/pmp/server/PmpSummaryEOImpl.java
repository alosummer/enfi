...
// ---------------------------------------------------------------------
public class PmpSummaryEOImpl extends OAEntityImpl {
    public static final int PROJECTID = 0;
    public static final int VERSIONNUM = 1;
    public static final int COOPERATORS = 2;
    public static final int PROJECTDESC = 3;
    public static final int PROJECTRANGE = 4;
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = 
                    (OAEntityDefImpl)EntityDefImpl.findDefObject("cux.oracle.apps.pa.pmp.server.PmpSummaryEO");
        }
    ...
    /**Sets <code>value</code> as the attribute value for Cooperators
     */
    public void setCooperators(String value) {
        setAttributeInternal(COOPERATORS, value);
    }

    /**Gets the attribute value for ProjectDesc, using the alias name ProjectDesc
     */
    public String getProjectDesc() {
        return (String)getAttributeInternal(PROJECTDESC);
    }

    /**Sets <code>value</code> as the attribute value for ProjectDesc
     */
    public void setProjectDesc(String value) {
        setAttributeInternal(PROJECTDESC, value);
    }

    /**Gets the attribute value for ProjectRange, using the alias name ProjectRange
     */
    public String getProjectRange() {
        return (String)getAttributeInternal(PROJECTRANGE);
    }

    /**Sets <code>value</code> as the attribute value for ProjectRange
     */
