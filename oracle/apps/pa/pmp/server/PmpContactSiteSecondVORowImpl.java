...
// ---------------------------------------------------------------------
public class PmpContactSiteSecondVORowImpl extends OAViewRowImpl {
    public static final int PROJECTID = 0;
    public static final int VERSIONNUM = 1;
    public static final int SITETYPE = 2;
    public static final int SITENAME = 3;
    public static final int OFFICELOCATION = 4;
     ...
     */
    public PmpContactSiteSecondVORowImpl() {
    }

    /**Gets PmpContractSiteEO entity object.
     */
    public PmpContactSiteEOImpl getPmpContractSiteEO() {
        return (PmpContactSiteEOImpl)getEntity(0);
    }
    ...
    /**Gets the attribute value for SITE_TYPE using the alias name SiteType
     */
    public String getSiteType() {
        return (String)getAttributeInternal(SITETYPE);
    }

    /**Sets <code>value</code> as attribute value for SITE_TYPE using the alias name SiteType
     */
    ...
    /**Gets the attribute value for OFFICE_LOCATION using the alias name OfficeLocation
     */
    public String getOfficeLocation() {
        return (String)getAttributeInternal(OFFICELOCATION);
    }

    /**Sets <code>value</code> as attribute value for OFFICE_LOCATION using the alias name OfficeLocation
     */
    public void setOfficeLocation(String value) {
        setAttributeInternal(OFFICELOCATION, value);
    }
    ...
    /**Sets <code>value</code> as attribute value for POSTCODE using the alias name Postcode
     */
