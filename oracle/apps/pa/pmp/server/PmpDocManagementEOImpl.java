...
// ---------------------------------------------------------------------
public class PmpDocManagementEOImpl extends OAEntityImpl {
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = 
                    (OAEntityDefImpl)EntityDefImpl.findDefObject("cux.oracle.apps.pa.pmp.server.PmpDocManagementEO");
        }
    ...
    /**Sets <code>value</code> as the attribute value for Requirment
     */
    public void setRequirment(String value) {
        setAttributeInternal(REQUIRMENT, value);
    }

    /**Gets the attribute value for DesignConsultation, using the alias name DesignConsultation
     */
    public String getDesignConsultation() {
        return (String)getAttributeInternal(DESIGNCONSULTATION);
    }

    /**Sets <code>value</code> as the attribute value for DesignConsultation
     */
    public void setDesignConsultation(String value) {
        setAttributeInternal(DESIGNCONSULTATION, value);
    }

    /**Gets the attribute value for EquipmentSupply, using the alias name EquipmentSupply
     */
    public String getEquipmentSupply() {
        return (String)getAttributeInternal(EQUIPMENTSUPPLY);
    }

    /**Sets <code>value</code> as the attribute value for EquipmentSupply
     */
    ...
    /**Sets <code>value</code> as the attribute value for Contracted
     */
