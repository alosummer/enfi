...
// ---------------------------------------------------------------------
public class PmpContactSiteEOImpl extends OAEntityImpl {
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject = 
                    (OAEntityDefImpl)EntityDefImpl.findDefObject("cux.oracle.apps.pa.pmp.server.PmpContactSiteEO");
        }
    ...
    /**Gets the attribute value for OfficeLocation, using the alias name OfficeLocation
     */
    public String getOfficeLocation() {
        return (String)getAttributeInternal(OFFICELOCATION);
    }

    /**Sets <code>value</code> as the attribute value for OfficeLocation
     */
