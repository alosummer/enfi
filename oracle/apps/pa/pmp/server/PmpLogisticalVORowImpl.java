...
// ---------------------------------------------------------------------
public class PmpLogisticalVORowImpl extends OAViewRowImpl {
     ...
     */
    public PmpLogisticalVORowImpl() {
    }

    /**Gets PmpLogisticalEO entity object.
     */
    public PmpLogisticalEOImpl getPmpLogisticalEO() {
        return (PmpLogisticalEOImpl)getEntity(0);
    }
    ...
    /**Gets the attribute value for LOGISTICAL_CONTENT using the alias name LogisticalContent
     */
    public String getLogisticalContent() {
        return (String)getAttributeInternal(LOGISTICALCONTENT);
    }

    /**Sets <code>value</code> as attribute value for LOGISTICAL_CONTENT using the alias name LogisticalContent
     */
    public void setLogisticalContent(String value) {
        setAttributeInternal(LOGISTICALCONTENT, value);
    }

    /**Gets the attribute value for LOGISTICAL_TYPE using the alias name LogisticalType
     */
    public String getLogisticalType() {
        return (String)getAttributeInternal(LOGISTICALTYPE);
    }

    /**Sets <code>value</code> as attribute value for LOGISTICAL_TYPE using the alias name LogisticalType
     */
    ...
    /**Gets the attribute value for LOGISTICAL_DESC using the alias name LogisticalDesc
     */
    public String getLogisticalDesc() {
        return (String)getAttributeInternal(LOGISTICALDESC);
    }

    /**Sets <code>value</code> as attribute value for LOGISTICAL_DESC using the alias name LogisticalDesc
     */
